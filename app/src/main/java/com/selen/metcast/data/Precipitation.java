...
public enum Precipitation {
    CLEAR {
        public String getName(Resources r) {
            return r.getString(R.string.clear);
        }
        ...
        public Drawable getPicture(Resources r) {
            return r.getDrawable(R.drawable.clear);
        }
    },
    CLOUDY {
        public String getName(Resources r) {
            return r.getString(R.string.cloudy);
        }
        ...
        public Drawable getPicture(Resources r) {
            return r.getDrawable(R.drawable.cloudy);
        }
    },
    RAIN {
        public String getName(Resources r) {
            return r.getString(R.string.rain);
        }
    ...
    SNOW {
        public String getName(Resources r) {
            return r.getString(R.string.snow);
        }
